...
<title>TransAssist - User Profile(friend)</title>
          ...
          <div class="col-md-12">
            <div class="tab-content"> 
              ...
              <div id="profile" class="tab-pane fade in active">
                <div class="row">
                  ...
                  <div class="col-md-8"> 
                    ...
                    <!-- Skills -->
                    <div class="sidebar">
                      <h5 class="main-title">Interests And Hobbies</h5>
                      ...
                      <div class="sidebar-information">
                        <ul class="single-category">
                          ...
                          <li class="row">
                            ...
                            <span class="subtitle col-xs-6"><%= us.phone %></span></li>
                          <li class="row">
                            <h6 class="title col-xs-6">E-mail</h6>
                            <span class="subtitle col-xs-6"><%= us.email %></span></li>
                        </ul>
                      </div>
                    </div>
              ...
              <div id="contact" class="tab-pane fade">
                <div class="profile-main">
                  <h3>Message Your Friend</h3>
                  <div class="profile-in">
                    <form action="/chatNewUser">
