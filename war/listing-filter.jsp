...
<title>TransAssist - Get Support</title>
...
<div id="main-wrapper"> 
    ...
    <div class="uou-block-2b">
      ...
      <a href="/index.jsp" ><img style="width:250px; height:50px;" src="images/logo2.png" alt=""></a> <a href="#" class="mobile-sidebar-button mobile-sidebar-toggle"><span></span></a>
         ...
         <ul class="sf-menu">
            ...
            <li class="active"> <a href="/listing-filter.jsp">Get Support</a> </li>
  ...
  <div class="profile-bnr sub-bnr user-profile-bnr">
    <div class="position-center-center">
      <div class="container">
        <h2>Search Health Professionals</h2>
      </div>
    </div>
  </div>
  
  <!-- search -->
  <form action="/SearchDocController" method="post">
  <div class="search-pro">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="map-search-fields">
              <div class="field">
                <input type="text" name="docname"  value="Doctor Name" placeholder="Doctor Name">
              </div>
              <div class="field">
            ...
            <div class="search-button">
               <button type="submit" value="submit">Search Health Professionals</button> 
            </div>
          </div>
        </div>
      </div>
    ...
    <% 
  List<Doctor> d=null;
  if(session.getAttribute("result1")==null){
  d=new LinkedList<Doctor>();
  }
  else{
	  d=(LinkedList<Doctor>)session.getAttribute("result1");
  }
	  %>
  ...
  <section class="pro-mem">
    <div class="container pb30">
      ...
      <div class="row"><% for(int i=0; i<d.size(); i++){ %>
        <a href="/user-profile-outsider.jsp?docId=<%=d.get(i).emailId%>"><div class="col-sm-3">
          <div class="uou-block-6a"> <img src="<%= ImagesServiceFactory.getImagesService().getServingUrl(ServingUrlOptions.Builder.withBlobKey(new BlobKey(d.get(i).profilePic))) %>" alt="">
            <h6><%= d.get(i).name %> <span><%= d.get(i).degree %></span></h6>
            <p><i class="fa fa-map-marker"></i> <%=d.get(i).hospLocality %></p>
          </div>
...
<div class="uou-block-4e">
		<div class="container">
			<div class="row">
				...
				<iframe src="https://www.google.com/maps/d/embed?mid=1f1cqLDeXBFR-tLzlwIR5GU6XOks" width="400" height="400"></iframe>
