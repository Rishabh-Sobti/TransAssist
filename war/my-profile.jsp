...
<title>TransAssist - My Profile</title>
        ...
        <div class="row"> 
          ...
          <div class="col-md-12">
            <ul class="nav nav-tabs">
              ...
              <li><a data-toggle="tab" href="#portfolio">Photos</a></li>
              <li><a data-toggle="tab" href="#blog-tab">Posts</a></li>
              ...
              <div id="profile" class="tab-pane fade in active">
                <div class="row">
                    ...
                    <div class="profile-main">
                      ...
                      <div class="profile-in">
                        ...
                        <div class="media-body">
                          <p><% if(mode==0){
                        	 out.println(doc.aboutMe); 
                          } 
                          else{
                        	  out.println(us.aboutMe);
                          }
                          %></p>
                        </div>
                      </div>
                  ...
                  <div class="col-md-8"> 
                    ...
                    <!-- Skills -->
                    <div class="sidebar">
                      <h6 class="main-title"><% if(mode==0){
                        	 out.println("Degree And Experience"); 
                          }
                          else{
                        	  out.println("Interests And Hobbies");
                          }
                          %></h6>
                      <div class="job-skills"> 
                        ...
                        <ul class="row">
                          <% if(mode==0){
                        	 out.println("  Degree -- "+doc.degree);%><br><% 
                        	 out.println("  Experience -- "+doc.experience);
                          }
                          else{
                        	  out.println("  "+us.hobbies);
                          }
                          %>
                        </ul>
                      </div>
                  ...
                  <div class="col-md-4"> 
                    ...
                    <!-- Professional Details -->
                    <div class="sidebar">
                      <h6 class="main-title">Personal Details</h6>
                      <div class="sidebar-information">
                        <ul class="single-category">
                          <li class="row">
                            <h6 class="title col-xs-6">Name</h6>
                            <span class="subtitle col-xs-6"><% if(mode==0){
                        	 out.println(doc.name); 
                          }
                          else{
                        	  out.println(us.name);
                          ...
                          <li class="row">
                            ...
                            <span class="subtitle col-xs-6"><% if(mode==0){
                        	 out.println(doc.birthDate.toString()); 
                          }
                          else{
                        	  out.println(us.birthDate.toString());
                          }
                          %></span></li>
                          <li class="row">
                            <h6 class="title col-xs-6">Location</h6>
                            <span class="subtitle col-xs-6"><% if(mode==0){
                        	 out.println(doc.hospLocality); 
                          }
                          else{
                        	  out.println(us.location);
                          }
                          %></span></li>
                          <li class="row">
                            <h6 class="title col-xs-6">Study</h6>
                            <span class="subtitle col-xs-6"><% if(mode==0){
                        	 out.println(doc.degree); 
                          }
                          else{
                        	  out.println(us.employStatus);
                          }
                          %></span></li>
                          <li class="row">
                            <h6 class="title col-xs-6">Phone</h6>
                            <span class="subtitle col-xs-6"><% if(mode==0){
                        	 out.println(doc.mobileNo); 
                          }
                          else{
                        	  out.println(us.phone);
                          }
                          %></span></li>
                          <li class="row">
                            <h6 class="title col-xs-6">E-mail</h6>
                            <span class="subtitle col-xs-6"><a href="#."><% if(mode==0){
                        	 out.println(doc.emailId); 
                          }
                          else{
                        	  out.println(us.email);
                          }
                          %></a></span></li>
                        </ul>
                      </div>
                    ...
                    <!-- Social Profiles -->
                    <div class="sidebar">
                      <h6 class="main-title">Other Profiles</h6>
                      <ul class="socil">
                          ...
                          <div class="row">
                            <div class="col-xs-4"> 
                              ...
                              <div class="fol-name">
                                ...
                                <h6><a href="/user-profile(layout-1).jsp?docId=<%=docFrnd.get(j).emailId%>"><%= docFrnd.get(j).name %></a></h6>
                                 </div>
                            </div>
                            <!-- Location -->
                          ...
                          <div class="row">
                            <div class="col-xs-4"> 
                              ...
                              <div class="fol-name">
                                ...
                                <h6><a href="/user-profile(layout-1)3.jsp?userId=<%=userFrnd.get(j).email%>"> <%= userFrnd.get(j).name %></a></h6>
                                 </div>
                            </div>
                            <!-- Location -->
