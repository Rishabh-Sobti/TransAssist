									...
									<div class="row">
														...
														<li class="col-sm-8">
															<div class="progress">
																<div class="progress-bar" role="progressbar"
																	...
																	aria-valuemax="100" style="width: <%= (doc.rate[1]+doc.rate[2])*50 %>px;"></div>
															</div>
														</li>
													</ul>
													...
													<ul class="row">
														...
														<li class="col-sm-8">
															<div class="progress">
																<div class="progress-bar" role="progressbar"
																	aria-valuenow="60" aria-valuemin="0"
																	aria-valuemax="100" style="width: <%=(doc.rate[3]+doc.rate[4])*50 %>px;"></div>
															</div>
														</li>
													</ul>
													...
													<ul class="row">
														...
														<li class="col-sm-8">
															<div class="progress">
																<div class="progress-bar" role="progressbar"
																	aria-valuenow="60" aria-valuemin="0"
																	aria-valuemax="100" style="width: <%= doc.rate[5]*100 %>px;"></div>
															</div>
														</li>
													</ul>
										...
										<div class="col-md-4">
											...
											<div class="sidebar">
												...
												<div class="sidebar-information">
													<ul class="single-category">
														...
														<li class="row">
															<h6 class="title col-xs-6">Phone</h6> <span
															class="subtitle col-xs-6"><%= doc.mobileNo %></span>
														</li>
														<li class="row">
															<h6 class="title col-xs-6">Fax</h6> <span
															class="subtitle col-xs-6"><%= doc.fax %></span>
														</li>
														<li class="row">
															<h6 class="title col-xs-6">E-mail</h6> <span
															class="subtitle col-xs-6"><%= doc.emailId %></span>
														</li>
														<li class="row">
											...
											<div class="sidebar">
												...
												<div class="profile-in">
													<form action="/rateNreview" method="post">
												<input type="hidden" name="docId" value="<%=doc.emailId%>">
												<input
													type="number" style="height:40px" name="1" placeholder="Expertise(1-5)">
													<input
													type="number" style="height:40px" name="2" placeholder="Knowledge(1-5)"> <input
													type="number" style="height:40px" name="3" placeholder="Behaviour(1-5)"> <input
													type="number" style="height:40px" name="4" placeholder="Price(1-5)"> <input
													type="number" style="height:40px" name="5" placeholder="Services(1-5)">  
												<textarea name="rev" placeholder="Write a review!" required></textarea>
