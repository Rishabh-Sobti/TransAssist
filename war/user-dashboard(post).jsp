              ...
              <div class="sidebar-information">
                <div class="profile-usermenu">
                  <ul class="nav nav-links">
                    ...
                    <li class="active"> <a href="/user-dashboard(post).jsp#ggg"> <i class="fa fa-group"></i> Post </a> </li>
                    <li> <a href="/account.jsp#ggg"> <i class="fa fa-plus-circle"></i> Messages </a> </li>
                    <li> <a href="/user-dashboard(acc).jsp#ggg"> <i class="fa fa-cog"></i> Account Settings </a> </li>
          ...
          <div class="col-md-8">
            <div class="network" id="ggg">
              ...
              <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#connec">Photos</a></li>
                <li><a data-toggle="tab" href="#flow">Blog Post</a></li>
              </ul>
                  ...
                  <div class="net-work-in"> 
                    ...
                    <div class="main-mem"> 
										...
										<div class="profile-in">
											...
											<form action="<%= blobstoreService.createUploadUrl("/uploadPic") %>" enctype="multipart/form-data" method="post">
												<p>Please select an image to upload:</p>
												<input type="file" value="Upload an Image" name="pic" size="40"> 
												<br><br>
                  ...
                  <div class="net-work-in"> 
                    ...
                    <div class="main-mem"> 
										...
										<div class="profile-in">
											...
											<form action="<%= blobstoreService.createUploadUrl("/uploadBlog") %>" enctype="multipart/form-data" method="post">
												<p>Please select an image to accompany your post:</p>
												<input type="file" value="Upload an Image" name="pic" size="40"> 
												<br><br>
												<textarea name="sub" placeholder="Subject of the Post"></textarea>
												<textarea name="content" rows="30" placeholder="Your views here!"></textarea>
